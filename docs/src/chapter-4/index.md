...
- 代表演習と詳細解答は付録C（第4章）を参照: ../appendices/c.md#ex-sol-ch4
...
適用のコツと用語は用語集も参照（→ 付録D: 用語集・索引: ../appendices/d.md#rice-の定理-rices-theorem）。
...
補足の例：
【用語の脚注】補有限（→ ../appendices/d.md#補有限-cofinite）
