...
- **向いている読者**: 章を読んだあとに、理解したつもりの項目と実際に説明・証明できる項目を切り分けたい読者
- **使うタイミング**: 各章の読了直後、演習に入る前、復習前の棚卸し
- **対応章**: 第1章〜第12章
- **本文との使い分け**: 定義や定理の説明が曖昧なら本文へ戻り、演習で手が止まるなら章末問題と [付録C]({{ '/appendices/c/' | relative_url }}) を併用してください。
- **読み方**: まず未達項目を特定し、その後に本文・章末問題・付録C・付録Eへ戻ると、弱点補強の順序を決めやすくなります。

## 章別クイックナビ

### Part I: 数学的基礎

- [第1章: 数学的基礎](#learning-check-ch1)
- [第2章: 計算理論の基礎](#learning-check-ch2)
- [第3章: 形式言語とオートマトン理論](#learning-check-ch3)

### Part II: 計算理論

- [第4章: 計算可能性](#learning-check-ch4)
- [第5章: 計算複雑性理論](#learning-check-ch5)
- [第6章: アルゴリズムの数学的解析](#learning-check-ch6)

### Part III: 高度なトピック

- [第7章: データ構造の理論](#learning-check-ch7)
- [第8章: グラフ理論とネットワーク](#learning-check-ch8)
- [第9章: 論理学・形式的手法](#learning-check-ch9)

### Part IV: 応用理論

- [第10章: 情報理論](#learning-check-ch10)
- [第11章: 暗号理論の数学的基礎](#learning-check-ch11)
- [第12章: 並行計算の理論](#learning-check-ch12)
...
#### 集合演算
- [ ] 和集合（∪）の定義と性質を理解している
- [ ] 共通部分（∩, intersection）の定義と性質を理解している
- [ ] 差集合（\）と対称差（⊕）を計算できる
- [ ] ド・モルガンの法則を証明できる
- [ ] 冪集合の概念を理解している
...
#### 多項式階層
- [ ] \\(\\Sigma_k^{\\mathrm{P}}\\), \\(\\Pi_k^{\\mathrm{P}}\\), \\(\\Delta_k^{\\mathrm{P}}\\) クラスの定義を理解している
- [ ] 多項式階層の崩壊の概念を理解している
...
- [ ] LTLの基本演算子を理解している
- [ ] LTL式の意味を理解している
- [ ] 安全性（safety）と活性（liveness）の性質を理解している
