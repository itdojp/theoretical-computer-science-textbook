...
1. <span id="exq-ch12-001"></span>2つのプロセスが交互に実行される以下のプログラムで、
...
- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-001)

2. <span id="exq-ch12-002"></span>CCS で以下のプロセスの双模倣等価性を判定せよ：
   (a) a.b.0 + a.c.0 と a.(b.0 + c.0)
   (b) (a.0 | b.0)\\{a} と b.0

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-002)

3. <span id="exq-ch12-003"></span>哲学者の食事問題を Petri ネットでモデル化し、
   デッドロックが起こることを示せ。

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-003)

4. <span id="exq-ch12-004"></span>n プロセスのベーカリーアルゴリズムが相互排除を満たすことを証明せよ。

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-004)

### 発展問題

5. <span id="exq-ch12-005"></span>分散システムにおける論理時計について：
   (a) Lamport 時計の定義と性質を述べよ
   (b) ベクトル時計との違いを説明せよ

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-005)

6. <span id="exq-ch12-006"></span>コンセンサス数について：
   (a) 各同期プリミティブのコンセンサス数を求めよ
   (b) 階層定理を説明せよ

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-006)

7. <span id="exq-ch12-007"></span>ロックフリーキューの実装：
   (a) Michael-Scott アルゴリズムを説明せよ
   (b) ABA 問題とその対策を論ぜよ

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-007)

8. <span id="exq-ch12-008"></span>弱メモリモデルについて：
   (a) TSO と PSO の違いを説明せよ
   (b) メモリバリアの必要性を例を挙げて示せ

- **詳細解答**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-008)

### 探究課題

9. <span id="exq-ch12-009"></span>ブロックチェーンのコンセンサスアルゴリズムについて調査し、
   Proof of Work、Proof of Stake、PBFT の特徴を比較せよ。

- **調査ガイド**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-009)

10. <span id="exq-ch12-010"></span>トランザクショナルメモリについて調査し、
    ソフトウェア実装とハードウェア実装の得失を論ぜよ。

- **調査ガイド**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-010)

11. <span id="exq-ch12-011"></span>アクターモデルについて調査し、
    共有メモリモデルとの違いと実装例（Erlang、Akka）を説明せよ。

- **調査ガイド**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-011)

12. <span id="exq-ch12-012"></span>形式的検証ツール（TLA+、SPIN、NuSMV など）について調査し、
    産業界での応用例を示せ。

---

- **調査ガイド**: [付録Cの対応解答](../appendices/c/#ex-sol-ch12-012)
