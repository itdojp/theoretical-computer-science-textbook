...
本文を一度追う機械換算時間と、証明・代表演習を含む標準学習時間は別の指標です。各コース・各章の学習負荷と前提は、公開サイトの[「学習の進め方」](https://itdojp.github.io/theoretical-computer-science-textbook/introduction/learning-guide/)を参照してください。
